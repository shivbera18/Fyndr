...
- **Git:** `init commit` squashed, `shivbera18 <164228363+shivbera18@users.noreply.github.com>` so counted. Small commits, branch PR. Merge PRs with a regular merge commit — NEVER squash — so every granular commit stays counted on `main`.
